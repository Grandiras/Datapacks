...
execute as @e[type=armor_stand,tag=last_block_mined] if score @s player_id = hammer_current player_id as @s at @s positioned ~ ~ ~ run function server:hammer/mine_chunk
