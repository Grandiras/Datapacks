...
execute if data entity @s Inventory[{Slot:-106b}].components.minecraft:custom_data.is_crab_claw run return run attribute @s minecraft:block_interaction_range base set 7
