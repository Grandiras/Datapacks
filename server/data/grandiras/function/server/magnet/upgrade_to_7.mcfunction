...
kill @e[type=item,nbt={Item:{id:"minecraft:heavy_core",count:1,components:{"minecraft:custom_data":{is_magnet_second_stage:true}}},OnGround:1b}]
kill @e[type=item,nbt={Item:{id:"minecraft:nether_star",count:1},OnGround:1b}]