...
kill @e[type=item,nbt={Item:{id:"minecraft:heavy_core",count:1,components:{"minecraft:custom_data":{is_magnet:true}}},OnGround:1b}]
kill @e[type=item,nbt={Item:{id:"minecraft:obsidian",count:10},OnGround:1b}]